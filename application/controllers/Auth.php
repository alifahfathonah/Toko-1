...
class Auth extends CI_Controller {
	...
	public function pilih_kota()
	{
		...
		$this->load->view('frontend/auth/kota',$this->data);
	}
	...
	public function login()
	{
		...
		if ($this->form_validation->run() == FALSE || !isset($response['success']) || $response['success'] <> TRUE)
		{
			...
			// _render_page == view
			$this->_render_page('frontend/auth/login', $this->data);
		}
		else
		{
	...
	public function profil()
	{
		...
		$this->load->view('frontend/auth/profil', $this->data);
	}
	...
	public function edit_profil($id)
	{
		...
		$this->_render_page('frontend/auth/edit_profil', $this->data);
	}
	...
	public function reset_password($code = NULL){
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				$this->_render_page('frontend/auth/reset_password', $this->data);
			}
			else
			{
