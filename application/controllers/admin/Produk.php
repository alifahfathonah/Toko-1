...
class Produk extends CI_Controller
{
    ...
    if ($this->form_validation->run() == FALSE)
    {
      ...
      else
      {
        ...
        if ($_FILES['foto']['error'] <> 4)
        {
          ...
          if (!$this->upload->do_upload('foto') or !$this->upload->do_upload('foto_b') or !$this->upload->do_upload('foto_c'))
          {
            ...
            else
            {
              ...
              $data = array(
                ...
                'berat' 				  => $this->input->post('berat'),
                'foto_c'            => $nmfile,
                'foto_type_c'       => $foto['file_ext'],
                'foto_b'            => $nmfile.'1',
                'foto_type_b'       => $foto['file_ext'],
                'foto'            => $nmfile.'2',
        ...
        if ($_FILES['foto']['error'] <> 4)
        {
          ...
          if (!$this->upload->do_upload('foto') or !$this->upload->do_upload('foto_b') or !$this->upload->do_upload('foto_c'))
          {
            ...
            else
            {
              ...
              $dirb        = "assets/images/produk/".$delete->foto_b.$delete->foto_type_b;
              $dirc        = "assets/images/produk/".$delete->foto_c.$delete->foto_type_c;
  ...
  public function delete($id)
  {
    ...
    $dir        = "assets/images/produk/".$delete->foto.$delete->foto_type;
    $dira      = "assets/images/produk/".$delete->foto_b.$delete->foto_type_b;
    $dirb      = "assets/images/produk/".$delete->foto_c.$delete->foto_type_c;
    $dir_thumb  = "assets/images/produk/".$delete->foto.'_thumb'.$delete->foto_type;
