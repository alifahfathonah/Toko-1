...
class Cart extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('frontend/cart/body', $this->data);
	}
	...
	public function terima()
	{
		...
		redirect('cart/history_detail/'.$id_trans);			
	}	
	...
	public function checkout()
	{
		...
		$this->load->view('frontend/cart/finished', $this->data);
	...
	public function download_invoice($id)
	{
		...
		if ($row)
		{
			...
			$this->load->view('frontend/cart/download_invoice', $this->data);
	...
	public function history()
	{
		...
		$this->load->view('frontend/cart/history', $this->data);
	}
	...
	public function history_detail($id)
	{
		...
		$this->load->view('frontend/cart/history_detail', $this->data);
	}
	...
	public function kurirdata()
	{
		...
		if(!empty($data['rajaongkir']['results']))
		{
			...
			$this->load->view('frontend/cart/datakurir',$data);
		}
	}
