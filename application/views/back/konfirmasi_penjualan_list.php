              ...
              <div class="box-body">
                ...
                <div class="table-responsive no-padding">
                        ...
                        <th style="text-align: center">Aksi</th>
										...
										<tbody>
											<?php foreach ($konfirmasi_pembayaran as $konfirmasi):?>
											<tr>
												...
												<td style="text-align:center">
                                                        ...
                                                        <?php
                                                            if(empty($konfirmasi->foto)) {echo "Kosong";}
                                                            else{
												...
												<td style="text-align:center"><a href="<?php echo base_url('admin/penjualan/') ?>"><button class="btn btn-primary"><i class="fa fa-eye"></i></button></a> <a href="<?php echo base_url('admin/konfirmasi/delete/'.$konfirmasi->id_pembayaran) ?>"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a></td>
											</tr>
											<?php endforeach;?>
										</tbody>
									</table>
