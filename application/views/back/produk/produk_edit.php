          ...
          <div class="col-lg-12">
              ...
              <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <img src="<?php echo base_url('assets/images/produk/'.$produk->foto_b.$produk->foto_type_b.'') ?>" width="200px"/>
                    <img src="<?php echo base_url('assets/images/produk/'.$produk->foto_c.$produk->foto_type_c.'') ?>" width="200px"/>
									</div>
									<div class="form-group"><label>Gambar :<p>Jika mengubah gambar, disarankan mengubah semua foto atau tidak mengubah sama sekali untuk menghindari <span style="color: red">error</span> Pada Daftar Gambar Produk.</p></label>
										<input type="file" class="btn btn-success" name="foto" id="foto" onchange="tampilkanPreview(this,'preview')"/><br>
                    <input type="file" class="btn btn-success" name="foto_b" id="foto_b" onchange="tampilkanPreview(this,'previewb')"/><br>
                    <input type="file" class="btn btn-success" name="foto_c" id="foto_c" onchange="tampilkanPreview(this,'previewc')"/>
										<br><p><b>Preview Gambar</b><br>
										<img id="preview" src="" alt="" width="30%"/>
                    <img id="previewb" src="" alt="" width="30%"/>
                    <img id="previewc" src="" alt="" width="30%"/>
									</div>
