                  ...
                  <div class="row">
                    <input class="form-control" name="hd" type="hidden" id="c" size="30" onkeyup="hitung();" readonly/>
									...
									<div class="form-group"><label>Gambar</label>
										<input type="file" class="btn btn-success" name="foto_c" id="foto" onchange="tampilkanPreview(this,'preview')"/><br>
										<input type="file" class="btn btn-success" name="foto_b" id="foto" onchange="tampilkanPreview(this,'preview_b')"/><br>
										<input type="file" class="btn btn-success" name="foto" id="foto" onchange="tampilkanPreview(this,'preview_c')"/><br>
										<br><p><b>Preview Gambar</b><br>
										<img id="preview" src="" alt="" width="30%"/>
										<img id="preview_b" src="" alt="" width="30%"/>
										<img id="preview_c" src="" alt="" width="30%"/>
									</div>
