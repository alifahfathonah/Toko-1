          ...
          <div class="col-lg-12">
              ...
              <div class="box-body">
								...
								<?php echo form_open_multipart($action);?>
									...
									<div class="form-group"><label>Profil Singkat Pada Footer 200 Karakter </label>
										<?php echo form_input($desc_profil, $company->desc_profil);?>
									</div>
									...
									<div class="form-group"><label>Maps</label>
										<?php echo form_textarea($company_maps, $company->company_maps);?>
									</div>
									...
									<div class="form-group"><label>Logo Baru</label>
										<input type="file" class="btn btn-primary" name="foto" id="foto" onchange="tampilkanPreview(this,'preview')"/>
